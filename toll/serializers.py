...
class TollSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model =  Toll
		fields = ('name', 'location', 'amount_vehicle_car', 'amount_vehicle_truck', 'amount_vehicle_lcv', 'amount_vehicle_3axel', 'amount_vehicle_4to6axel', 'amount_vehicle_7axel', 'amount_vehicle_hcm')
